...
%      dNdxi(1,1)=((xii(2) - 1)*(xii(3) - 1)*(xii(1) + xii(2) + xii(3) + 2))/8 + ((xii(1) - 1)*(xii(2) - 1)*(xii(3) - 1))/8;
%      dNdxi(1,2)=((xii(1) - 1)*(xii(3) - 1)*(xii(1) + xii(2) + xii(3) + 2))/8 + ((xii(1) - 1)*(xii(2) - 1)*(xii(3) - 1))/8;
%      dNdxi(1,3)=((xii(1) - 1)*(xii(2) - 1)*(xii(1) + xii(2) + xii(3) + 2))/8 + ((xii(1) - 1)*(xii(2) - 1)*(xii(3) - 1))/8;
%      dNdxi(2,1)=((xii(1) + 1)*(xii(2) - 1)*(xii(3) - 1))/8 - ((xii(2) - 1)*(xii(3) - 1)*(xii(2) - xii(1) + xii(3) + 2))/8;
%      dNdxi(2,2)=- ((xii(1) + 1)*(xii(3) - 1)*(xii(2) - xii(1) + xii(3) + 2))/8 - ((xii(1) + 1)*(xii(2) - 1)*(xii(3) - 1))/8;
%      dNdxi(2,3)=- ((xii(1) + 1)*(xii(2) - 1)*(xii(2) - xii(1) + xii(3) + 2))/8 - ((xii(1) + 1)*(xii(2) - 1)*(xii(3) - 1))/8;
%      dNdxi(3,1)=- ((xii(2) + 1)*(xii(3) - 1)*(xii(1) + xii(2) - xii(3) - 2))/8 - ((xii(1) + 1)*(xii(2) + 1)*(xii(3) - 1))/8;
%      dNdxi(3,2)=- ((xii(1) + 1)*(xii(3) - 1)*(xii(1) + xii(2) - xii(3) - 2))/8 - ((xii(1) + 1)*(xii(2) + 1)*(xii(3) - 1))/8;
%      dNdxi(3,3)=((xii(1) + 1)*(xii(2) + 1)*(xii(3) - 1))/8 - ((xii(1) + 1)*(xii(2) + 1)*(xii(1) + xii(2) - xii(3) - 2))/8;
%      dNdxi(4,1)=- ((xii(2) + 1)*(xii(3) - 1)*(xii(1) - xii(2) + xii(3) + 2))/8 - ((xii(1) - 1)*(xii(2) + 1)*(xii(3) - 1))/8;
%      dNdxi(4,2)=((xii(1) - 1)*(xii(2) + 1)*(xii(3) - 1))/8 - ((xii(1) - 1)*(xii(3) - 1)*(xii(1) - xii(2) + xii(3) + 2))/8;
%      dNdxi(4,3)=- ((xii(1) - 1)*(xii(2) + 1)*(xii(1) - xii(2) + xii(3) + 2))/8 - ((xii(1) - 1)*(xii(2) + 1)*(xii(3) - 1))/8;
%      dNdxi(5,1)=- ((xii(2) - 1)*(xii(3) + 1)*(xii(1) + xii(2) - xii(3) + 2))/8 - ((xii(1) - 1)*(xii(2) - 1)*(xii(3) + 1))/8;
%      dNdxi(5,2)=- ((xii(1) - 1)*(xii(3) + 1)*(xii(1) + xii(2) - xii(3) + 2))/8 - ((xii(1) - 1)*(xii(2) - 1)*(xii(3) + 1))/8;
%      dNdxi(5,3)=((xii(1) - 1)*(xii(2) - 1)*(xii(3) + 1))/8 - ((xii(1) - 1)*(xii(2) - 1)*(xii(1) + xii(2) - xii(3) + 2))/8;
%      dNdxi(6,1)=- ((xii(2) - 1)*(xii(3) + 1)*(xii(1) - xii(2) + xii(3) - 2))/8 - ((xii(1) + 1)*(xii(2) - 1)*(xii(3) + 1))/8;
%      dNdxi(6,2)=((xii(1) + 1)*(xii(2) - 1)*(xii(3) + 1))/8 - ((xii(1) + 1)*(xii(3) + 1)*(xii(1) - xii(2) + xii(3) - 2))/8;
%      dNdxi(6,3)=- ((xii(1) + 1)*(xii(2) - 1)*(xii(1) - xii(2) + xii(3) - 2))/8 - ((xii(1) + 1)*(xii(2) - 1)*(xii(3) + 1))/8;
%      dNdxi(7,1)=((xii(2) + 1)*(xii(3) + 1)*(xii(1) + xii(2) + xii(3) - 2))/8 + ((xii(1) + 1)*(xii(2) + 1)*(xii(3) + 1))/8;
%      dNdxi(7,2)=((xii(1) + 1)*(xii(3) + 1)*(xii(1) + xii(2) + xii(3) - 2))/8 + ((xii(1) + 1)*(xii(2) + 1)*(xii(3) + 1))/8;
%      dNdxi(7,3)=((xii(1) + 1)*(xii(2) + 1)*(xii(1) + xii(2) + xii(3) - 2))/8 + ((xii(1) + 1)*(xii(2) + 1)*(xii(3) + 1))/8;
%      dNdxi(8,1)=((xii(2) + 1)*(xii(3) + 1)*(xii(1) - xii(2) - xii(3) + 2))/8 + ((xii(1) - 1)*(xii(2) + 1)*(xii(3) + 1))/8;
%      dNdxi(8,2)=((xii(1) - 1)*(xii(3) + 1)*(xii(1) - xii(2) - xii(3) + 2))/8 - ((xii(1) - 1)*(xii(2) + 1)*(xii(3) + 1))/8;
%      dNdxi(8,3)=((xii(1) - 1)*(xii(2) + 1)*(xii(1) - xii(2) - xii(3) + 2))/8 - ((xii(1) - 1)*(xii(2) + 1)*(xii(3) + 1))/8;
%      dNdxi(9,1)=-(xii(1)*(xii(2) - 1)*(xii(3) - 1))/2;
%      dNdxi(9,2)=-((xii(1)^2 - 1)*(xii(3) - 1))/4;
%      dNdxi(9,3)=-((xii(1)^2 - 1)*(xii(2) - 1))/4;
%      dNdxi(10,1)=((xii(2)^2 - 1)*(xii(3) - 1))/4;
%      dNdxi(10,2)=(xii(2)*(xii(1) + 1)*(xii(3) - 1))/2;
%      dNdxi(10,3)=((xii(2)^2 - 1)*(xii(1) + 1))/4;
%      dNdxi(11,1)=(xii(1)*(xii(2) + 1)*(xii(3) - 1))/2;
%      dNdxi(11,2)=((xii(1)^2 - 1)*(xii(3) - 1))/4;
%      dNdxi(11,3)=((xii(1)^2 - 1)*(xii(2) + 1))/4;
%      dNdxi(12,1)=-((xii(2)^2 - 1)*(xii(3) - 1))/4;
%      dNdxi(12,2)=-(xii(2)*(xii(1) - 1)*(xii(3) - 1))/2;
%      dNdxi(12,3)=-((xii(2)^2 - 1)*(xii(1) - 1))/4;
%      dNdxi(13,1)=(xii(1)*(xii(2) - 1)*(xii(3) + 1))/2;
%      dNdxi(13,2)=((xii(1)^2 - 1)*(xii(3) + 1))/4;
%      dNdxi(13,3)=((xii(1)^2 - 1)*(xii(2) - 1))/4;
%      dNdxi(14,1)=-((xii(2)^2 - 1)*(xii(3) + 1))/4;
%      dNdxi(14,2)=-(xii(2)*(xii(1) + 1)*(xii(3) + 1))/2;
%      dNdxi(14,3)=-((xii(2)^2 - 1)*(xii(1) + 1))/4;
%      dNdxi(15,1)=-(xii(1)*(xii(2) + 1)*(xii(3) + 1))/2;
%      dNdxi(15,2)=-((xii(1)^2 - 1)*(xii(3) + 1))/4;
%      dNdxi(15,3)=-((xii(1)^2 - 1)*(xii(2) + 1))/4;
%      dNdxi(16,1)=((xii(2)^2 - 1)*(xii(3) + 1))/4;
%      dNdxi(16,2)=(xii(2)*(xii(1) - 1)*(xii(3) + 1))/2;
%      dNdxi(16,3)=((xii(2)^2 - 1)*(xii(1) - 1))/4;
%      dNdxi(17,1)=-((xii(3)^2 - 1)*(xii(2) - 1))/4;
%      dNdxi(17,2)=-((xii(3)^2 - 1)*(xii(1) - 1))/4;
%      dNdxi(17,3)=-(xii(3)*(xii(1) - 1)*(xii(2) - 1))/2;
%      dNdxi(18,1)=((xii(3)^2 - 1)*(xii(2) - 1))/4;
%      dNdxi(18,2)=((xii(3)^2 - 1)*(xii(1) + 1))/4;
%      dNdxi(18,3)=(xii(3)*(xii(1) + 1)*(xii(2) - 1))/2;
%      dNdxi(19,1)=-((xii(3)^2 - 1)*(xii(2) + 1))/4;
%      dNdxi(19,2)=-((xii(3)^2 - 1)*(xii(1) + 1))/4;
%      dNdxi(19,3)=-(xii(3)*(xii(1) + 1)*(xii(2) + 1))/2;
%      dNdxi(20,1)=((xii(3)^2 - 1)*(xii(2) + 1))/4;
%      dNdxi(20,2)=((xii(3)^2 - 1)*(xii(1) - 1))/4;
%      dNdxi(20,3)=(xii(3)*(xii(1) - 1)*(xii(2) + 1))/2;
    end
 end
end
