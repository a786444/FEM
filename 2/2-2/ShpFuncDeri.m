function dNdxi=ShpFuncDeri(nelnd,ndime,xii)
 ...
 elseif (ndime == 3)
    ...
    if (nelnd == 10)% 3D 3 2
     ...
     dNdxi(7,2)=0;
     dNdxi(7,3)=4*xii(1);
     dNdxi(8,1)=4 - 4*xii(2) - 4*xii(3) - 8*xii(1);
     dNdxi(8,2)=-4*xii(1);
     dNdxi(8,3)=-4*xii(1);
     dNdxi(9,1)=-4*xii(2);
     dNdxi(9,2)=4 - 8*xii(2) - 4*xii(3) - 4*xii(1);
     dNdxi(9,3)=-4*xii*(2);
     dNdxi(10,1)=-4*xii(3);
     dNdxi(10,2)=-4*xii(3);
     dNdxi(10,3)=4 - 4*xii(2) - 8*xii(3) - 4*xii(1);
    end
    if (nelnd == 8)%3D 4 1
        dNdxi(1,1)=-0.125*(1-xii(2))*(1-xii(3));
        dNdxi(1,2)=-0.125*(1-xii(1))*(1-xii(3));
        dNdxi(1,3)=-0.125*(1-xii(2))*(1-xii(1));
        ...
        dNdxi(6,3)=0.125*(1-xii(2))*(1+xii(3));
